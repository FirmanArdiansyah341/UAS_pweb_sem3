...
<body>
    ...
    $data = mysqli_query($koneksi, "SELECT * FROM kamar WHERE nomor_faktur = '$nomor_faktur'");
  ...
  <div class="container-fluid">
    ...
    <div class="container mt-3">
        ...
        <form action="proses_update_kamar.php" method="post">
            <input type="hidden" name="nomor_faktur" value="<?php echo $d['nomor_faktur']; ?>">
            <div class="mb-3">
                <label for="nama_pemesan">Nama Pemesan</label>
                <input type="text" class="form-control" id="nama_pemesan" placeholder="Nama Pemesan" name="nama_pemesan" value="<?php echo $d['nama_pemesan']; ?>">
            </div>
            <div class="mb-3 mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nomor_kamar" placeholder="No. Kamar" name="nomor_kamar" value="<?php echo $d['nomor_kamar']; ?>">
            </div>
            <div class="mb-3">
                <label for="tgl_pesan">Tgl. Pesan</label>
                <input type="date" class="form-control" id="tgl_pesan" placeholder="Tgl. Pesan" name="tgl_pesan" value="<?php echo $d['tgl_pesan']; ?>">
            </div>
            <div class="mb-3">
                <label for="tgl_habis">Tgl. Habis</label>
                <input type="date" class="form-control" id="tgl_habis" placeholder="Tgl. Habis" name="tgl_habis" value="<?php echo $d['tgl_habis']; ?>">
            </div>
            <div class="mb-3">
